...
const taskSlice = createSlice({
  ...
  initialState: [
    ...
    },
    {
      ...
      deadline: "2025-02-25",
      description:
        "Create a responsive UI design for the homepage using Figma.",
    ...
    },
    {
      ...
      deadline: "2025-02-28",
      description:
        "Improve response time by implementing caching and indexing.",
    ...
    },
    {
      ...
      deadline: "2025-03-10",
      description:
        "Deploy the application on Vercel for frontend and AWS for backend.",
      "create At": "2025-02-20",
      "modify At": "2025-02-20",
    },
    {
  ...
  reducers: {
    ...
    updateTasksFromSocket: (state, action) => {
      state = action.payload; // Sync tasks from the socket
    },
  },
});
